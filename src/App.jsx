      ...
      {location.pathname === "/" && (
        <>
          <section className="flex flex-col items-center justify-center min-h-screen text-center px-4 z-10 relative">
            <h1 className="text-6xl font-bold mb-4 text-white">Welcome to Fisherman's Compass</h1>
            <h3 className="text-5xl font-bold mb-4 text-white">Find Fish, Anytime, Anywhere.</h3>
            <p className="text-2xl mb-6 text-white">Real-time GPS-powered fish finder for smarter fishing.</p>
