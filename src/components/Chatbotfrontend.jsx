...
shadow-lg flex flex-col fixed bottom-0 right-5 animate-slide-up z-50">
          <div className="w-full bg-orange-500 text-white p-3
flex justify-between items-center rounded-t-lg"
          ...
          <div className="flex-1 p-3 overflow-y-auto flex flex-col">
            {messages.map((msg, index) => (
              <div
                key={index}
                className={`p-3 rounded-lg mb-2 max-w-[75%] z-50 break-words ${ msg.sender === "user"
          ...
          <div className="flex border-t border-gray-300 p-2">
            ...
            <button onClick={sendMessage} className="bg-orange-500 text-white p-2">
              <FaPaperPlane />
            </button>
          </div>
        </div>
